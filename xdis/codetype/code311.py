...
Code311FieldTypes.update(
    {
        "co_qualname": str,
        "co_exception_table": str
    }
)


class Code311(Code38):
    """Class for a Python 3.11+ code object used when a Python
    interpreter less than 3.11 is working on Python3 bytecode. It also
    functions as an object that can be used to build or write a
